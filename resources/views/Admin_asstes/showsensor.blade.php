                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($sensors as $admin)
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ url('admin/editsensor/' . $admin->id) }}"><i
                                                            class="far fa-edit"></i></a> &nbsp; <a
                                                        href="{{ url('admin/deletesensor/' . $admin->id) }}"
                                                        style="color: red"><i class="far fa-trash-alt"></i></a> &nbsp; <a
                                                        href="{{ url('admin/viewsensordetail/' . $admin->id) }}"><i
